...
import aso.mo.asoplayer.main.common.utils.ConvertUtils
...
class HttpInterceptor(
    ...
    private fun refreshToken(): Int {
        ...
        val base64 =
            ConvertUtils.stringToBase64("${cloudKeys.spotifyClientId!!}:${cloudKeys.spotifySecret!!}")
...
const val spotifyToken = "aso.mo.asoplayer.main.common.network.spotifyToken"