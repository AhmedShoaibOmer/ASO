...
import aso.mo.asoplayer.main.explore.RecentlyPlayedRepository
import aso.mo.asoplayer.main.explore.RecentlyPlayedRoomDatabase
import aso.mo.asoplayer.main.songs.basicSongsOrder
...
class PlaybackService : MediaBrowserServiceCompat() {
    ...
    override fun onCreate() {
        ...
        recentRepo = RecentlyPlayedRepository(
            RecentlyPlayedRoomDatabase.getDatabase(application).recentDao()
        )
        ...
        mediaSource = MediaStoreSource(
            this, MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, basicSongsSelection, arrayOf(
                basicSongsSelectionArg
            ),
            basicSongsOrder
        )
        serviceScope.launch {
