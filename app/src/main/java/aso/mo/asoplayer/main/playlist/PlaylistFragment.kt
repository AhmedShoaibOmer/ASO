...
class PlaylistFragment : BaseFragment(), OnItemClickListener, View.OnClickListener {
    ...
    private fun updateViews() {
        if (items.isEmpty()) {
            ...
            playlistsNum.text = resources.getQuantityString(
                R.plurals.numberOfPlaylists,
                items.count(),
                items.count()
            )
        }
    ...
    override fun onItemClick(position: Int, sharableView: View?) {
        ...
        val extras = FragmentNavigator.Extras.Builder()
            ...
            .build()
        val action =
            PlaylistFragmentDirections.actionPlaylistFragmentToPlaylistSongsFragment(
                transitionName,
                items[position]
            )
    ...
    override fun onItemLongClick(position: Int) {
        ...
        val action =
            PlaylistFragmentDirections.actionPlaylistFragmentToPlaylistMenuBottomSheetDialogFragment(
