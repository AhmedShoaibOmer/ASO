...
import aso.mo.asoplayer.common.App
import aso.mo.asoplayer.main.common.utils.ImageUtils
import aso.mo.asoplayer.main.common.utils.UriFileUtils
    ...
    fun editPlaylist(
        ...
        viewModelScope.launch {
            withContext(Dispatchers.IO) {
                ...
                val rowsUpdated =
                    getApplication<App>().contentResolver.update(uri, values, where, whereVal)
                if (rowsUpdated < 1) {
