package aso.mo.asoplayer.main.common.image
 ...
 */
class CircularTransparentCenter(private val radiusFactor: Float = defaultRadiusFactor) :
    BitmapTransformation() {
    private val version = 1
    private val id = "aso.mo.asoplayer.main.common.image.CircularTransparentCenter.$version"
