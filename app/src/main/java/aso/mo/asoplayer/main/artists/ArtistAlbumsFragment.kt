...
import aso.mo.asoplayer.databinding.FragmentArtistAlbumsBinding
...
class ArtistAlbumsFragment : BaseFragment(), OnItemClickListener {
    ...
    private fun setupRecyclerView() {
        ...
        artistAlbumsRV.layoutManager = FlexboxLayoutManager(activity).apply {
            ...
            justifyContent =
                if (artist.albumsCount > 1) JustifyContent.SPACE_EVENLY else JustifyContent.FLEX_START
        }
    ...
    override fun onItemLongClick(position: Int) {
        val action =
            ArtistAlbumsFragmentDirections.actionArtistAlbumsFragmentToAlbumsMenuBottomSheetDialogFragment(
