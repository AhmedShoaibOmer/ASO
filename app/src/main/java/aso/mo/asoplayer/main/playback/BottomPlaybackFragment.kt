...
import aso.mo.asoplayer.databinding.FragmentBottomPlaybackBinding
import aso.mo.asoplayer.main.MainFragmentDirections
        ...
        clickableView.setOnClickListener {
            viewModel.currentItem.value?.let {
                ...
                val extras = FragmentNavigator.Extras.Builder()
                    .addSharedElement(sharableView, transitionName).build()
                val action =
                    MainFragmentDirections.actionMainFragmentToPlaybackFragment(transitionName)
